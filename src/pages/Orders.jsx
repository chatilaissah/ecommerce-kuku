...
import { Package, Clock, CheckCircle, Truck, ShoppingBag, Filter, Search } from 'lucide-react';
...
const Orders = () => {
  ...
  const userOrders = state.orders.filter(order => 
    order.userId === state.user.id || state.user.isAdmin
  );
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">
            {state.user.isAdmin ? 'All Orders' : 'My Orders'}
          </h1>
                          ...
                          <div key={index} className="flex items-center space-x-4">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-gray-600 text-sm">
                                Qty: {item.quantity} × KSh {item.product.price}
                              </p>
                            </div>
